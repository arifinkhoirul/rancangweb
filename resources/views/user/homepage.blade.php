                    ...
                    <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                        <div class="image-section">
                            <div class="primary-image">
                                <img src="assets/img/about/about-14.webp" alt="Corporate office environment"
                                    class="img-fluid">
                            ...
                            <div class="image-grid">
                                <img src="assets/img/about/about-3.webp" alt="Professional workspace"
                                    class="img-fluid grid-img">
                                <img src="assets/img/about/about-7.webp" alt="Team collaboration"
                                    class="img-fluid grid-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="testimonials-slider-wrapper">
                    <div class="testimonials-carousel">
                        ...
                        <div class="testimonial-card featured" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <div class="user-profile">
                                <div class="avatar">
                                    <img src="{{asset('image/person/person-m-11.webp')}}" alt="User" class="img-fluid">
                                </div>
                                <div class="user-info">
                                    <h4>Michael Chen</h4>
